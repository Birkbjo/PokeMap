...
function rarityIndicator(rarity) {
    ...
    var circleSpan = document.createElement('small');
    circleSpan.style.width = '15px';
    circleSpan.style.height = '15px';
    circleSpan.style.backgroundColor = color;
    circleSpan.style.borderRadius = '100%';
    circleSpan.style.border = '2px solid #000';
    circleSpan.style.display = 'inline-block';
    circleSpan.style.verticalAlign = 'text-bottom';
    circleSpan.title = rarity;

    return circleSpan.outerHTML;
...
function pokemonLabel(name, rarity, types, disappear_time, id, latitude, longitude, encounter_id) {
    ...
    var rarity_display = rarityIndicator(rarity);
    var types_display = "";
    ...
    <div>
      ...
      <a href='/?q=${latitude},${longitude}' target='_blank' title='Link in PokeMap'>Share</a>
    </div>`;
